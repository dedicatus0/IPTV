        ...
        'Init':function(){
            ...
            if(MAC.Cookie.Get('user_id') !=undefined && MAC.Cookie.Get('user_id')!=''){
                ...
                if($('.mac_user').length >0) {
                    ...
                    html += '<ul class="logged"><li><a target="_blank" href="/index.php/user/index.html">鐢ㄦ埛涓績</a></li><li class="logout"><a class="logoutbt" href="javascript:;" onclick="MAC.User.Logout();" target="_self"><i class="user-logout"></i>閫€鍑�</a></li></ul>'
